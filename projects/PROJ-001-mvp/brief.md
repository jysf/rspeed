...
- [x] STAGE-002 (shipped on 2026-05-03) — Measurement core: latency probe, parallel-connection download/upload, snapshot fan-out
- [~] STAGE-003 (active) — Output & UX: human/json/silent renderers, error rendering, TTY detection
...
**Count:** 2 shipped / 1 active / 2 proposed
